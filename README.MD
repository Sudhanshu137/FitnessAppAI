...
❌ No passwords are stored in application databases  
❌ No custom login or signup APIs
...
➡️ One Keycloak user maps to exactly one User Service record.
...
Swagger is enabled in each microservice
